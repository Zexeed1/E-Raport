...
class siswa extends Model
{
    ...
    {
        return $this->belongsToMany(mapel::class, 'mapel_siswa2')->where('kelas', $this->kelas)->withPivot(['uh1', 'uh2', 't1', 't2', 't3', 't4', 'uts', 'uas', 'desk_p', 'proses', 'produk', 'pro1', 'pro2', 'desk_k'])->withTimestamps();
    }
